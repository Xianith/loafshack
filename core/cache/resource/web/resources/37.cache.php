...
<link href="https://fonts.googleapis.com/css?family=Playfair+Display+SC:400,700|Playfair+Display:400,700|Poppins:300,400,700" rel="stylesheet">
  ...
  <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
       ...
       <a class="navbar-brand" href="http://loafshack.com">
       ...
       <div class="collapse navbar-collapse" id="navbarCollapse">
         <ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item dropdown">
                   ...
                   <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                     <a class="dropdown-item" href="weddint-party/bros.html">Bros</a>
                     <a class="dropdown-item" href="weddint-party/gals.html">Gals</a>
                     <a class="dropdown-item" href="#">Other VIPs</a>
                   </div>
           </li>
           <li class="nav-item">
             <a class="nav-link" href="gifts.html">Gifts & Shit</a>
           </li>
           <li class="nav-item">
             <a class="nav-link" href="#">FAQ</a>
           </li>
           <li class="nav-item">
             <a class="nav-link" href="#">Holla!</a>
           </li>
