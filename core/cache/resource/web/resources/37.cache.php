<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="col-md-8 offset-md-2">
<h3>Where did "Loafshack" come from (and why is it your wedding hashtag)?</h3>

<p>Long ago, before we were courageous enough for the traditional four-letter "L word," we used "loaf" as a term of endearment. One night, while dancing around in our finest attire (pajamas) to the classic B-52\'s song, we subbed in our ~phrase~ and it stuck. </p>

<p>Our humble abode is often referred to as the Loafshack, so it\'s only fitting we use it in our wedding hashtag. </p>
<p>(Also, #Bengina sounded a little too raunchy for such a classy event.)</p>

<h3>How\'d you two weirdos meet? Start dating? Decide to say "til death do us part?"</h3>

<p>We started off as coworkers. Taboo, we know. To make matters better (or worse?) we sat next to each other. Neither party involved wanted to admit interest. We spent a while doing ~coupley~ things (like seeing movies together and going out for drinks...) when we finally decided to give it a shot.</p>

<p>After a year and a half of officially dating, we went on what Gina thought was a nice, normal vacation together. Ben had been scheming for months. When he popped the question, madness ensued. Gina thought he had fallen on some rocks at Mile Rock Beach in San Francisco, but alas. He was kneeling. After a lot of "WHAT" and "ARE YOU JOKING" exclaimations, she said yes (YAY!). </p>

<p>And now, we party.</p>

<h3>What should I wear?</h3>

<p>The dress code will be semi-formal, but please feel free to bring your dancing shoes to change into! We will be tearing up the dance floor and hope you\'ll join us in celebration.</p>

<h3>Are kids allowed?</h3>

<p>We regret to inform you... ah, just kidding-- bring the kids! We know we share our favorite town with a mouse and his entourage, so we couldn\'t deny our younger family members. We\'ll even have some chicken fingers for dinner ;)</p>

<h3>Can I take pictures?</h3>

<p>There will be professional photographers capturing moments throughout the day. Just don\'t obstruct what we\'re paying them to while you snap away!
</p></div>',
    'richtext' => 1,
    'template' => 5,
    'menuindex' => 5,
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1493260883,
    'editedby' => 2,
    'editedon' => 1498704774,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1493260860,
    'publishedby' => 2,
    'menutitle' => 'FAQ',
    'donthit' => 0,
    'privateweb' => 0,
  ...
  <div class="container body-container">
    ...
    <div class="row ">
            <div class="col-md-12" style="padding: 0px;">
                  <!-- <img src="core/components/loafshack/text-min.png" class="wow fadeIn img-fluid center" data-wow-delay="1s"> -->

                  <div class="wow fadeIn header-image-block" data-wow-delay="1s">
                    <h1>Frequently Asked Questions</h1>
                    <p></p> 
                  </div>
                  <div>
                   <img style="object-fit: cover; width: 100%; height: 400px; object-position: 50% 58%;" src="imgs/3.jpg">
                  </div>
           </div>
    </div>
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'type' => 'image',
          'name' => 'header-image',
          'caption' => 'This is used to show an image in the header of a template',
          'description' => '',
          'editor_type' => 0,
          'category' => 0,
          'locked' => false,
