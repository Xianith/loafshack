...
<div class="card-group">
  <div class="card">
    <img class="card-img-top" src="http://i1.kym-cdn.com/entries/icons/original/000/007/835/der_oma.png" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Christa <span class="title">- Maid of Honor</span></h4>
  ...
  <div class="card">
    <img class="card-img-top" src="http://i1.kym-cdn.com/entries/icons/original/000/007/835/der_oma.png" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Victoria <span class="title bestman">- Bridesmaid</span></h4>
  ...
  <div class="card">
    <img class="card-img-top" src="http://i1.kym-cdn.com/entries/icons/original/000/007/835/der_oma.png" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Elise <span class="title">- Bridesmaid</span></h4>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Know for ???</small>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="http://i1.kym-cdn.com/entries/icons/original/000/007/835/der_oma.png" alt="Card image cap">
    <div class="card-block">
<h4 class="card-title">Lauren <span class="title">- Bridesmaid</span></h4>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Know for ???</small>
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1493260803,
    'editedby' => 3,
    'editedon' => 1496341803,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1493260800,
    'publishedby' => 2,
    'menutitle' => 'Gals',
    'donthit' => 0,
    'privateweb' => 0,
