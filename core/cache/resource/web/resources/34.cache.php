...
<style>
.card-group .card:first-child .card-img-top, .card-group .card:last-child .card-img-top {
height:250px;
width:250px;
...
.card-block {
color: white;
background-color: rgba(58, 102, 117, 1);
margin-left:2px;
margith-right:2px;
}
...
<div class="card-group">
  <div class="card">
    <img class="card-img-top" src="[[!++site_url]]imgs/ben.jpg" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Dan <span class="title">- Groomsman</span></h4>
      <p class="card-text">My second oldest brother and the one that I’ve spent a majority of my life hanging around. I guess we met when I started out in this game that they call life. I don’t really remember too much growing up except for the original DOOM and Total annihilation, I don’t think we ever played them together, more so fought over who got to play.</p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Known since birth.</small>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="[[!++site_url]]imgs/ben.jpg" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Spencer <span class="title bestman">- Bestman</span></h4>
      <p class="card-text">Spencer and I met way back over yonder, at the turn of the century one could say. My mom actually educated him and we had met while I was waiting to go home and he had snuck out of detention. We played Linnys walk about which still exists apparently… and the rest they say is shennigans…. or history.</p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Known for too long.</small>
    </div>
  </div>
</div>

<div class="card-group" style="margin-top:10px; margin-bottom: 10px">
 <div class="card">
    <img class="card-img-top" src="[[!++site_url]]imgs/ben.jpg" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Kyle <span class="title">- Groomsman</span></h4>
      <p class="card-text">Kyle and I first met at a party and I knew then that we’d be the greatest of buds. Primarily due to his awesome humor and love / obsession with Star Wars. We had many a parties and many more laughs. </p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Know for several years.</small>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="[[!++site_url]]imgs/ben.jpg" alt="Card image cap">
    <div class="card-block">
<h4 class="card-title">Raj <span class="title">- Groomsman</span></h4>
      <p class="card-text">Rag and I met a few years back when we both worked in the dungeon (aka the UCF Library) we didn’t hang outside of work too much but we both loved Minecraft and would play the crap out of that on our down time (which was all the time). I’d always invite Raj to go out and hang with friends and do social things but he’d always have some excuse, and thus Raj-Mc-No-Show was born! He better show up to this...</p>
    </div>
    <div class="card-footer">
      <small class="text-muted">Know for a couple years.</small>
    </div>
  </div>
</div>',
    'richtext' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1493260781,
    'editedby' => 3,
    'editedon' => 1496414002,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1493260740,
    'publishedby' => 2,
    'menutitle' => 'Bros',
    'donthit' => 0,
    'privateweb' => 0,
